      ...
      <div className="flex min-h-18 flex-wrap items-center gap-3 px-4 py-3 lg:px-6">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <Link
            ...
            className="flex min-h-9 items-center gap-1.5 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary transition-colors hover:bg-primary/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
