...
export const customVehicleSchema = z.object({
  ...
  consumptionKwhPer100km: positiveNumber.max(99999.999),
...
export type VehiclePatch = { nickname?: string; isDefault?: boolean; consumptionKwhPer100km?: number; settings?: Partial<z.infer<typeof vehicleSettingsSchema>> };
export type VehicleCommand =
  | { kind: "catalog"; catalogId: string; consumptionKwhPer100km: number; startingBatteryPct: number }
