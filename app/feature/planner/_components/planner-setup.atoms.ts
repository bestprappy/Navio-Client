...
import { filterDestinations } from "./data";
...
export const filteredDestinationsAtom = atom((get) =>
  filterDestinations(get(destinationQueryAtom)),
);

export const canSubmitPlannerAtom = atom(
  (get) => get(selectedDestinationAtom) !== null,
);
