...
import type { HomeTab } from "./home.atoms";
      ...
      <div className="rounded-xl border border-border bg-muted/40 p-4">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <span className="text-xs text-amber-600 font-medium">
            After {route.stops.length} charges: +
            {route.stops.reduce((acc, s) => acc + s.batteryGainPct, 0)}%
          </span>
          ...
          >
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1 text-amber-600 font-medium">
                <Zap className="w-3 h-3" />+{stop.batteryGainPct}%
              </span>
              <span className="flex items-center gap-1">
                <span
                  className={[
...
export function HomePanel() {
  ...
  return (
    ...
    >
      {/* Tab bar */}
      <div
        className="flex shrink-0 border-b border-border px-5 pt-4 gap-1"
        role="tablist"
      >
        {TABS.map((tab) => (
          <button
